...
public class Calandar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String eventTwo = "Teacher Word Day";
        ...
        String eventSeven = "Bridgeland HOSA Regional Competition";
        String eventEight = "Bridgeland Science Olympiad District Competition";
        String eventNine = "Bridgeland FBLA Meeting";
        ...
        calendarView.setOnDateChangeListener(new CalendarView.OnDateChangeListener() {
            ...
            public void onSelectedDayChange(@NonNull CalendarView calendarView, int i, int i1, int i2) {
                ...
                if (date.equals("4/7/2023")) {
                    String event = eventOne + "\n" + "\n" + "\n" +  eventTwo;
                    firstDate.setText(event);
                    secondDate.setText(eventThree);
                }
                else if (date.equals("4/10/2023")) {
                    firstDate.setText(eventTwo);
                }
                else if (date.equals("3/22/2023")) {
                    firstDate.setText(eventThree);
                }
                else if (date.equals("3/23/2023")) {
                    firstDate.setText(eventThree);
                }
                else if (date.equals("3/24/2023")) {
                    firstDate.setText(eventThree);
                }
                ...
                else if (date.equals("1/19/2023")) {
                    firstDate.setText(eventNine);
                }
                else if (date.equals("1/20/2023")) {
                    firstDate.setText(eventOne);
                }
                else if (date.equals("1/21/2023")) {
                    firstDate.setText(eventTwo);
                }
                ...
                else if (date.equals("2/3/2023")||date.equals("2/4/2023")||date.equals("2/5/2023"))
                {
